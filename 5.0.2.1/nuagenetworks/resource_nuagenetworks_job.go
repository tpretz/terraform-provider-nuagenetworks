    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_ingress_external_service_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_egress_acl_template", "parent_egress_adv_fwd_entry_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vcenter_cluster", "parent_egress_adv_fwd_template", "parent_zfb_request", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_vcenter", "parent_ingress_acl_template", "parent_gateway", "parent_vnf", "parent_vsd"},
            },
            "parent_ingress_acl_entry_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_egress_acl_template", "parent_egress_adv_fwd_entry_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_policy_group", "parent_vcenter_cluster", "parent_egress_adv_fwd_template", "parent_zfb_request", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_vcenter", "parent_ingress_acl_template", "parent_gateway", "parent_vnf", "parent_vsd"},
            },
            ...
            "parent_vcenter_cluster": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_egress_acl_template", "parent_egress_adv_fwd_entry_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_egress_adv_fwd_template", "parent_zfb_request", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_vcenter", "parent_ingress_acl_template", "parent_gateway", "parent_vnf", "parent_vsd"},
            },
            ...
            "parent_zfb_request": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_egress_acl_template", "parent_egress_adv_fwd_entry_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vcenter_cluster", "parent_egress_adv_fwd_template", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_vcenter", "parent_ingress_acl_template", "parent_gateway", "parent_vnf", "parent_vsd"},
            },
            "parent_vsc": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_egress_acl_template", "parent_egress_adv_fwd_entry_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vcenter_cluster", "parent_egress_adv_fwd_template", "parent_zfb_request", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_vcenter", "parent_ingress_acl_template", "parent_gateway", "parent_vnf", "parent_vsd"},
            },
            "parent_hsc": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_egress_acl_template", "parent_egress_adv_fwd_entry_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vcenter_cluster", "parent_egress_adv_fwd_template", "parent_zfb_request", "parent_vsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_vcenter", "parent_ingress_acl_template", "parent_gateway", "parent_vnf", "parent_vsd"},
            },
            "parent_vrs": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_egress_acl_template", "parent_egress_adv_fwd_entry_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vcenter_cluster", "parent_egress_adv_fwd_template", "parent_zfb_request", "parent_vsc", "parent_hsc", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_vcenter", "parent_ingress_acl_template", "parent_gateway", "parent_vnf", "parent_vsd"},
            },
