    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_l2_domain", "parent_subnet", "parent_ns_port", "parent_zone", "parent_patnat_pool", "parent_vport", "parent_tier", "parent_address_map"},
            },
            "parent_l2_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_subnet", "parent_ns_port", "parent_zone", "parent_patnat_pool", "parent_vport", "parent_tier", "parent_address_map"},
            },
            "parent_subnet": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_ns_port", "parent_zone", "parent_patnat_pool", "parent_vport", "parent_tier", "parent_address_map"},
            },
            "parent_ns_port": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_zone", "parent_patnat_pool", "parent_vport", "parent_tier", "parent_address_map"},
            },
            "parent_zone": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_ns_port", "parent_patnat_pool", "parent_vport", "parent_tier", "parent_address_map"},
            },
            "parent_patnat_pool": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_ns_port", "parent_zone", "parent_vport", "parent_tier", "parent_address_map"},
            },
            "parent_vport": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_ns_port", "parent_zone", "parent_patnat_pool", "parent_tier", "parent_address_map"},
            },
            "parent_tier": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_ns_port", "parent_zone", "parent_patnat_pool", "parent_vport", "parent_address_map"},
            },
            "parent_address_map": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_ns_port", "parent_zone", "parent_patnat_pool", "parent_vport", "parent_tier"},
            },
        },
    }
}
