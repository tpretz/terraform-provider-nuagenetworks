...
func resourceApplicationCreate(d *schema.ResourceData, m interface{}) error {
    ...
    o := &vspk.Application{
        ...
        AssociatedL7ApplicationSignatureID: d.Get("associated_l7_application_signature_id").(string),
    }
...
func resourceApplicationUpdate(d *schema.ResourceData, m interface{}) error {
    ...
    o.AssociatedL7ApplicationSignatureID = d.Get("associated_l7_application_signature_id").(string)
