    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_tca": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_ns_port", "parent_ns_redundant_gateway_group", "parent_enterprise", "parent_wan_service", "parent_vsg_redundant_port", "parent_wireless_port", "parent_ssid_connection", "parent_vlan", "parent_vport", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ns_gateway", "parent_port", "parent_redundancy_group", "parent_vm", "parent_container", "parent_gateway", "parent_vsd"},
            },
            "parent_ns_port": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_tca", "parent_ns_redundant_gateway_group", "parent_enterprise", "parent_wan_service", "parent_vsg_redundant_port", "parent_wireless_port", "parent_ssid_connection", "parent_vlan", "parent_vport", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ns_gateway", "parent_port", "parent_redundancy_group", "parent_vm", "parent_container", "parent_gateway", "parent_vsd"},
            },
            "parent_ns_redundant_gateway_group": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_tca", "parent_ns_port", "parent_enterprise", "parent_wan_service", "parent_vsg_redundant_port", "parent_wireless_port", "parent_ssid_connection", "parent_vlan", "parent_vport", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ns_gateway", "parent_port", "parent_redundancy_group", "parent_vm", "parent_container", "parent_gateway", "parent_vsd"},
            },
            "parent_enterprise": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_tca", "parent_ns_port", "parent_ns_redundant_gateway_group", "parent_wan_service", "parent_vsg_redundant_port", "parent_wireless_port", "parent_ssid_connection", "parent_vlan", "parent_vport", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ns_gateway", "parent_port", "parent_redundancy_group", "parent_vm", "parent_container", "parent_gateway", "parent_vsd"},
            },
            ...
            "parent_vm": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_tca", "parent_ns_port", "parent_ns_redundant_gateway_group", "parent_enterprise", "parent_wan_service", "parent_vsg_redundant_port", "parent_wireless_port", "parent_ssid_connection", "parent_vlan", "parent_vport", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ns_gateway", "parent_port", "parent_redundancy_group", "parent_container", "parent_gateway", "parent_vsd"},
            },
            "parent_container": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_tca", "parent_ns_port", "parent_ns_redundant_gateway_group", "parent_enterprise", "parent_wan_service", "parent_vsg_redundant_port", "parent_wireless_port", "parent_ssid_connection", "parent_vlan", "parent_vport", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ns_gateway", "parent_port", "parent_redundancy_group", "parent_vm", "parent_gateway", "parent_vsd"},
            },
