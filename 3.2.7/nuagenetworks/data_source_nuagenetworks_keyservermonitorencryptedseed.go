    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_key_server_monitor_seed": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_key_server_monitor_sek", "parent_key_server_monitor"},
            },
            "parent_key_server_monitor_sek": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_key_server_monitor_seed", "parent_key_server_monitor"},
            },
            "parent_key_server_monitor": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_key_server_monitor_seed", "parent_key_server_monitor_sek"},
            },
        },
    }
}
