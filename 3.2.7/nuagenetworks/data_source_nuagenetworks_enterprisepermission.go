    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_shared_network_resource": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_ns_port", "parent_wan_service", "parent_vlan", "parent_patnat_pool", "parent_ns_gateway", "parent_port", "parent_redundancy_group", "parent_gateway"},
            },
            "parent_ns_port": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_wan_service", "parent_vlan", "parent_patnat_pool", "parent_ns_gateway", "parent_port", "parent_redundancy_group", "parent_gateway"},
            },
            "parent_wan_service": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_ns_port", "parent_vlan", "parent_patnat_pool", "parent_ns_gateway", "parent_port", "parent_redundancy_group", "parent_gateway"},
            },
            "parent_vlan": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_ns_port", "parent_wan_service", "parent_patnat_pool", "parent_ns_gateway", "parent_port", "parent_redundancy_group", "parent_gateway"},
            },
            "parent_patnat_pool": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_ns_port", "parent_wan_service", "parent_vlan", "parent_ns_gateway", "parent_port", "parent_redundancy_group", "parent_gateway"},
            },
            ...
            "parent_port": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_ns_port", "parent_wan_service", "parent_vlan", "parent_patnat_pool", "parent_ns_gateway", "parent_redundancy_group", "parent_gateway"},
            },
            "parent_redundancy_group": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_ns_port", "parent_wan_service", "parent_vlan", "parent_patnat_pool", "parent_ns_gateway", "parent_port", "parent_gateway"},
            },
            "parent_gateway": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_ns_port", "parent_wan_service", "parent_vlan", "parent_patnat_pool", "parent_ns_gateway", "parent_port", "parent_redundancy_group"},
            },
        },
    }
}
