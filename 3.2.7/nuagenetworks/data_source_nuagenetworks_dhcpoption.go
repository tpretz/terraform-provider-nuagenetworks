    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_shared_network_resource": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vm_interface", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_subnet", "parent_zone", "parent_vport"},
            },
            "parent_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_vm_interface", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_subnet", "parent_zone", "parent_vport"},
            },
            "parent_vm_interface": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_domain", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_subnet", "parent_zone", "parent_vport"},
            },
            "parent_host_interface": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_domain", "parent_vm_interface", "parent_l2_domain", "parent_bridge_interface", "parent_subnet", "parent_zone", "parent_vport"},
            },
            "parent_l2_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_domain", "parent_vm_interface", "parent_host_interface", "parent_bridge_interface", "parent_subnet", "parent_zone", "parent_vport"},
            },
            "parent_bridge_interface": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_domain", "parent_vm_interface", "parent_host_interface", "parent_l2_domain", "parent_subnet", "parent_zone", "parent_vport"},
            },
            "parent_subnet": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_domain", "parent_vm_interface", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_zone", "parent_vport"},
            },
            "parent_zone": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_domain", "parent_vm_interface", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_subnet", "parent_vport"},
            },
            "parent_vport": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_shared_network_resource", "parent_domain", "parent_vm_interface", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_subnet", "parent_zone"},
            },
        },
    }
}
