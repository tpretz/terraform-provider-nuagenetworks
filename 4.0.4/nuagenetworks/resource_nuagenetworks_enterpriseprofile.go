...
func resourceEnterpriseProfileCreate(d *schema.ResourceData, m interface{}) error {
    ...
    if attr, ok := d.GetOk("dpi_enabled"); ok {
        o.DPIEnabled = attr.(bool)
    }
    ...
    if attr, ok := d.GetOk("externalservices"); ok {
        o.AssignExternalServices(attr.(vspk.ExternalServicesList))
    }
...
func resourceEnterpriseProfileRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("dpi_enabled", o.DPIEnabled)
    d.Set("name", o.Name)
