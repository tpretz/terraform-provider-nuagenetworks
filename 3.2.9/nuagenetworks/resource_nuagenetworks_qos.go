    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_l2_domain_template", "parent_subnet", "parent_zone_template", "parent_zone", "parent_vport", "parent_domain_template", "parent_subnet_template"},
            },
            "parent_host_interface": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_bridge_interface", "parent_l2_domain_template", "parent_subnet", "parent_zone_template", "parent_zone", "parent_vport", "parent_domain_template", "parent_subnet_template"},
            },
            "parent_l2_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_host_interface", "parent_bridge_interface", "parent_l2_domain_template", "parent_subnet", "parent_zone_template", "parent_zone", "parent_vport", "parent_domain_template", "parent_subnet_template"},
            },
            "parent_bridge_interface": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_host_interface", "parent_l2_domain", "parent_l2_domain_template", "parent_subnet", "parent_zone_template", "parent_zone", "parent_vport", "parent_domain_template", "parent_subnet_template"},
            },
            "parent_l2_domain_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_subnet", "parent_zone_template", "parent_zone", "parent_vport", "parent_domain_template", "parent_subnet_template"},
            },
            "parent_subnet": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_l2_domain_template", "parent_zone_template", "parent_zone", "parent_vport", "parent_domain_template", "parent_subnet_template"},
            },
            "parent_zone_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_l2_domain_template", "parent_subnet", "parent_zone", "parent_vport", "parent_domain_template", "parent_subnet_template"},
            },
            "parent_zone": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_l2_domain_template", "parent_subnet", "parent_zone_template", "parent_vport", "parent_domain_template", "parent_subnet_template"},
            },
            "parent_vport": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_l2_domain_template", "parent_subnet", "parent_zone_template", "parent_zone", "parent_domain_template", "parent_subnet_template"},
            },
            "parent_domain_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_l2_domain_template", "parent_subnet", "parent_zone_template", "parent_zone", "parent_vport", "parent_subnet_template"},
            },
            "parent_subnet_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_host_interface", "parent_l2_domain", "parent_bridge_interface", "parent_l2_domain_template", "parent_subnet", "parent_zone_template", "parent_zone", "parent_vport", "parent_domain_template"},
            },
        },
    }
}
...
func resourceQOSUpdate(d *schema.ResourceData, m interface{}) error {
    ...
    o.ServiceClass = d.Get("service_class").(string)
