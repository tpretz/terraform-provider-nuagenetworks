    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_vrs", "parent_tier", "parent_multi_nic_vport", "parent_floating_ip"},
            },
            "parent_l2_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_vrs", "parent_tier", "parent_multi_nic_vport", "parent_floating_ip"},
            },
            "parent_subnet": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_redirection_target", "parent_policy_group", "parent_vrs", "parent_tier", "parent_multi_nic_vport", "parent_floating_ip"},
            },
            "parent_redirection_target": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_policy_group", "parent_vrs", "parent_tier", "parent_multi_nic_vport", "parent_floating_ip"},
            },
            "parent_policy_group": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_vrs", "parent_tier", "parent_multi_nic_vport", "parent_floating_ip"},
            },
            "parent_vrs": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_tier", "parent_multi_nic_vport", "parent_floating_ip"},
            },
            "parent_tier": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_vrs", "parent_multi_nic_vport", "parent_floating_ip"},
            },
            "parent_multi_nic_vport": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_vrs", "parent_tier", "parent_floating_ip"},
            },
            "parent_floating_ip": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_vrs", "parent_tier", "parent_multi_nic_vport"},
            },
        },
    }
}
