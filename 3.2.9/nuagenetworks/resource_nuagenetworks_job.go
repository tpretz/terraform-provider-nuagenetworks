    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_redirection_target_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            "parent_l2_domain_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            "parent_redirection_target": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            "parent_enterprise": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            "parent_policy_group_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            ...
            "parent_egress_acl_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            "parent_ingress_adv_fwd_entry_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            "parent_ingress_external_service_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            "parent_ingress_acl_entry_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            ...
            "parent_vsc": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            "parent_hsc": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            "parent_vrs": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            ...
            "parent_ns_gateway": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_domain_template", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            "parent_domain_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_ingress_acl_template", "parent_gateway", "parent_vsd"},
            },
            ...
            "parent_gateway": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_vcenter_hypervisor", "parent_ingress_external_service_template_entry", "parent_l2_domain", "parent_redirection_target_template", "parent_l2_domain_template", "parent_redirection_target", "parent_enterprise", "parent_policy_group_template", "parent_app", "parent_egress_acl_template", "parent_ingress_adv_fwd_entry_template", "parent_ingress_external_service_template", "parent_ingress_acl_entry_template", "parent_policy_group", "parent_vsc", "parent_hsc", "parent_vrs", "parent_ingress_adv_fwd_template", "parent_egress_acl_entry_template", "parent_ns_gateway", "parent_domain_template", "parent_ingress_acl_template", "parent_vsd"},
            },
...
func resourceJobCreate(d *schema.ResourceData, m interface{}) error {
    ...
    if attr, ok := d.GetOk("parent_app"); ok {
