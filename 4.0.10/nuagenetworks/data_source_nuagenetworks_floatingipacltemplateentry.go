...
func dataSourceFloatingIPACLTemplateEntryRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("reflexive", FloatingIPACLTemplateEntry.Reflexive)
    ...
    d.Set("associated_application_id", FloatingIPACLTemplateEntry.AssociatedApplicationID)
    d.Set("associated_application_object_id", FloatingIPACLTemplateEntry.AssociatedApplicationObjectID)
    d.Set("associated_application_object_type", FloatingIPACLTemplateEntry.AssociatedApplicationObjectType)
