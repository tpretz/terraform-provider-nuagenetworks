...
func dataSourceDomainFIPAclTemplateEntryRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("reflexive", DomainFIPAclTemplateEntry.Reflexive)
    ...
    d.Set("associated_application_id", DomainFIPAclTemplateEntry.AssociatedApplicationID)
    d.Set("associated_application_object_id", DomainFIPAclTemplateEntry.AssociatedApplicationObjectID)
    d.Set("associated_application_object_type", DomainFIPAclTemplateEntry.AssociatedApplicationObjectType)
