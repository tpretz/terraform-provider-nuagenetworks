...
func resourceInfrastructureGatewayProfileCreate(d *schema.ResourceData, m interface{}) error {
    ...
    if attr, ok := d.GetOk("revert_behaviour"); ok {
        o.RevertBehaviour = attr.(bool)
    }
    if attr, ok := d.GetOk("revert_timer"); ok {
        o.RevertTimer = attr.(int)
    }
...
func resourceInfrastructureGatewayProfileRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("revert_behaviour", o.RevertBehaviour)
    d.Set("revert_timer", o.RevertTimer)
