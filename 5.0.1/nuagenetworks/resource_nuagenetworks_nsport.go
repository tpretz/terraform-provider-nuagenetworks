...
func resourceNSPort() *schema.Resource {
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "network_acceleration_enabled": &schema.Schema{
...
func resourceNSPortCreate(d *schema.ResourceData, m interface{}) error {
    ...
    o := &vspk.NSPort{
        ...
        UserMnemonic: d.Get("user_mnemonic").(string),
    }
    ...
    if attr, ok := d.GetOk("network_acceleration_enabled"); ok {
        o.NetworkAccelerationEnabled = attr.(bool)
    }
...
func resourceNSPortRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("network_acceleration_enabled", o.NetworkAccelerationEnabled)
...
func resourceNSPortUpdate(d *schema.ResourceData, m interface{}) error {
    ...
    o.UserMnemonic = d.Get("user_mnemonic").(string)
