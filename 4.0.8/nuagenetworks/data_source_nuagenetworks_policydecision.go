    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_vm_interface": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_host_interface", "parent_container_interface", "parent_bridge_interface"},
            },
            "parent_host_interface": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_vm_interface", "parent_container_interface", "parent_bridge_interface"},
            },
            "parent_container_interface": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_vm_interface", "parent_host_interface", "parent_bridge_interface"},
            },
            "parent_bridge_interface": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_vm_interface", "parent_host_interface", "parent_container_interface"},
            },
        },
    }
}
...
func dataSourcePolicyDecisionRead(d *schema.ResourceData, m interface{}) error {
    ...
    if attr, ok := d.GetOk("parent_vm_interface"); ok {
