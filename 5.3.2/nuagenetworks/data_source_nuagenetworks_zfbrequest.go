...
func dataSourceZFBRequestRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("associated_entity_type", ZFBRequest.AssociatedEntityType)
    d.Set("associated_gateway_id", ZFBRequest.AssociatedGatewayID)
    d.Set("associated_gateway_name", ZFBRequest.AssociatedGatewayName)
