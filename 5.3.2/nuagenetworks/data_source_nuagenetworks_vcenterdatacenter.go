...
func dataSourceVCenterDataCenterRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("manage_vrs_availability", VCenterDataCenter.ManageVRSAvailability)
    ...
    d.Set("secondary_data_uplink_vdf_control_vlan", VCenterDataCenter.SecondaryDataUplinkVDFControlVLAN)
    ...
    d.Set("primary_data_uplink_vdf_control_vlan", VCenterDataCenter.PrimaryDataUplinkVDFControlVLAN)
