...
func resourceVCenterHypervisorCreate(d *schema.ResourceData, m interface{}) error {
    ...
    if attr, ok := d.GetOk("manage_vrs_availability"); ok {
        o.ManageVRSAvailability = attr.(bool)
    }
    ...
    if attr, ok := d.GetOk("secondary_data_uplink_vdf_control_vlan"); ok {
        o.SecondaryDataUplinkVDFControlVLAN = attr.(int)
    }
    ...
    if attr, ok := d.GetOk("primary_data_uplink_vdf_control_vlan"); ok {
        o.PrimaryDataUplinkVDFControlVLAN = attr.(int)
    }
...
func resourceVCenterHypervisorRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("name", o.Name)
    d.Set("manage_vrs_availability", o.ManageVRSAvailability)
    ...
    d.Set("secondary_data_uplink_vdf_control_vlan", o.SecondaryDataUplinkVDFControlVLAN)
    ...
    d.Set("primary_data_uplink_vdf_control_vlan", o.PrimaryDataUplinkVDFControlVLAN)
    d.Set("primary_nuage_controller", o.PrimaryNuageController)
    d.Set("vrs_id", o.VrsId)
    d.Set("vrs_marked_as_available", o.VrsMarkedAsAvailable)
