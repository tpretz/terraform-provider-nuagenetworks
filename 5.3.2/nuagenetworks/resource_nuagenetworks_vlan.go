    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_ns_port": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_vsg_redundant_port", "parent_gateway_redundant_port", "parent_redundant_port", "parent_port"},
            },
            "parent_vsg_redundant_port": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_ns_port", "parent_gateway_redundant_port", "parent_redundant_port", "parent_port"},
            },
            "parent_gateway_redundant_port": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_ns_port", "parent_vsg_redundant_port", "parent_redundant_port", "parent_port"},
            },
            "parent_redundant_port": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_ns_port", "parent_vsg_redundant_port", "parent_gateway_redundant_port", "parent_port"},
            },
            "parent_port": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_ns_port", "parent_vsg_redundant_port", "parent_gateway_redundant_port", "parent_redundant_port"},
            },
        },
    }
}
...
func resourceVLANCreate(d *schema.ResourceData, m interface{}) error {
    ...
    if attr, ok := d.GetOk("shunt_vlan"); ok {
        o.ShuntVLAN = attr.(bool)
    }
