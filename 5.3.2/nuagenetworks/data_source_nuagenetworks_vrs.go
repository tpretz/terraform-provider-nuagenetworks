    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_vport": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_vsc", "parent_hsc", "parent_vm", "parent_container"},
            },
            "parent_vsc": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_vport", "parent_hsc", "parent_vm", "parent_container"},
            },
            "parent_hsc": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_vport", "parent_vsc", "parent_vm", "parent_container"},
            },
            "parent_vm": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_vport", "parent_vsc", "parent_hsc", "parent_container"},
            },
            "parent_container": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_vport", "parent_vsc", "parent_hsc", "parent_vm"},
            },
        },
    }
}
...
func dataSourceVRSRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("gateway_uuid", VRS.GatewayUUID)
