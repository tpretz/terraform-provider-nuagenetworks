...
func dataSourceZoneRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("associated_application_id", Zone.AssociatedApplicationID)
    d.Set("associated_application_object_id", Zone.AssociatedApplicationObjectID)
    d.Set("associated_application_object_type", Zone.AssociatedApplicationObjectType)
