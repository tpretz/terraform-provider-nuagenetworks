...
func dataSourceVCenterRead(d *schema.ResourceData, m interface{}) (err error) {
    ...
    d.Set("manage_vrs_availability", VCenter.ManageVRSAvailability)
    ...
    d.Set("secondary_data_uplink_vdf_control_vlan", VCenter.SecondaryDataUplinkVDFControlVLAN)
    ...
    d.Set("primary_data_uplink_vdf_control_vlan", VCenter.PrimaryDataUplinkVDFControlVLAN)
