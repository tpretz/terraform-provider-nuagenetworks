    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_zone", "parent_vrs", "parent_multi_nic_vport", "parent_floating_ip", "parent_trunk", "parent_overlay_mirror_destination"},
            },
            "parent_l2_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_zone", "parent_vrs", "parent_multi_nic_vport", "parent_floating_ip", "parent_trunk", "parent_overlay_mirror_destination"},
            },
            "parent_subnet": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_redirection_target", "parent_policy_group", "parent_zone", "parent_vrs", "parent_multi_nic_vport", "parent_floating_ip", "parent_trunk", "parent_overlay_mirror_destination"},
            },
            "parent_redirection_target": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_policy_group", "parent_zone", "parent_vrs", "parent_multi_nic_vport", "parent_floating_ip", "parent_trunk", "parent_overlay_mirror_destination"},
            },
            "parent_policy_group": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_zone", "parent_vrs", "parent_multi_nic_vport", "parent_floating_ip", "parent_trunk", "parent_overlay_mirror_destination"},
            },
            "parent_zone": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_vrs", "parent_multi_nic_vport", "parent_floating_ip", "parent_trunk", "parent_overlay_mirror_destination"},
            },
            "parent_vrs": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_zone", "parent_multi_nic_vport", "parent_floating_ip", "parent_trunk", "parent_overlay_mirror_destination"},
            },
            "parent_multi_nic_vport": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_zone", "parent_vrs", "parent_floating_ip", "parent_trunk", "parent_overlay_mirror_destination"},
            },
            "parent_floating_ip": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_zone", "parent_vrs", "parent_multi_nic_vport", "parent_trunk", "parent_overlay_mirror_destination"},
            },
            "parent_trunk": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_zone", "parent_vrs", "parent_multi_nic_vport", "parent_floating_ip", "parent_overlay_mirror_destination"},
            },
            "parent_overlay_mirror_destination": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_redirection_target", "parent_policy_group", "parent_zone", "parent_vrs", "parent_multi_nic_vport", "parent_floating_ip", "parent_trunk"},
            },
        },
    }
}
