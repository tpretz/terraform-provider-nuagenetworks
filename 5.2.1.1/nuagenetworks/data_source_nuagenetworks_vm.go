    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_qos", "parent_l2_domain", "parent_subnet", "parent_user", "parent_enterprise", "parent_egress_acl_template", "parent_zone", "parent_vport", "parent_vrs", "parent_ingress_acl_template"},
            },
            "parent_qos": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_subnet", "parent_user", "parent_enterprise", "parent_egress_acl_template", "parent_zone", "parent_vport", "parent_vrs", "parent_ingress_acl_template"},
            },
            "parent_l2_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_qos", "parent_subnet", "parent_user", "parent_enterprise", "parent_egress_acl_template", "parent_zone", "parent_vport", "parent_vrs", "parent_ingress_acl_template"},
            },
            "parent_subnet": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_qos", "parent_l2_domain", "parent_user", "parent_enterprise", "parent_egress_acl_template", "parent_zone", "parent_vport", "parent_vrs", "parent_ingress_acl_template"},
            },
            "parent_user": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_qos", "parent_l2_domain", "parent_subnet", "parent_enterprise", "parent_egress_acl_template", "parent_zone", "parent_vport", "parent_vrs", "parent_ingress_acl_template"},
            },
            "parent_enterprise": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_qos", "parent_l2_domain", "parent_subnet", "parent_user", "parent_egress_acl_template", "parent_zone", "parent_vport", "parent_vrs", "parent_ingress_acl_template"},
            },
            "parent_egress_acl_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_qos", "parent_l2_domain", "parent_subnet", "parent_user", "parent_enterprise", "parent_zone", "parent_vport", "parent_vrs", "parent_ingress_acl_template"},
            },
            "parent_zone": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_qos", "parent_l2_domain", "parent_subnet", "parent_user", "parent_enterprise", "parent_egress_acl_template", "parent_vport", "parent_vrs", "parent_ingress_acl_template"},
            },
            "parent_vport": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_qos", "parent_l2_domain", "parent_subnet", "parent_user", "parent_enterprise", "parent_egress_acl_template", "parent_zone", "parent_vrs", "parent_ingress_acl_template"},
            },
            "parent_vrs": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_qos", "parent_l2_domain", "parent_subnet", "parent_user", "parent_enterprise", "parent_egress_acl_template", "parent_zone", "parent_vport", "parent_ingress_acl_template"},
            },
            "parent_ingress_acl_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_qos", "parent_l2_domain", "parent_subnet", "parent_user", "parent_enterprise", "parent_egress_acl_template", "parent_zone", "parent_vport", "parent_vrs"},
            },
        },
    }
}
