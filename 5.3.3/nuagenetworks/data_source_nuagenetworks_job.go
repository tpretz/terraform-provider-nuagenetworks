    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_enterprise": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_egress_acl_template", "parent_vport", "parent_ingress_adv_fwd_template", "parent_ns_gateway", "parent_ingress_acl_template", "parent_redundancy_group", "parent_gateway"},
            },
            "parent_egress_acl_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_enterprise", "parent_vport", "parent_ingress_adv_fwd_template", "parent_ns_gateway", "parent_ingress_acl_template", "parent_redundancy_group", "parent_gateway"},
            },
            "parent_vport": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_enterprise", "parent_egress_acl_template", "parent_ingress_adv_fwd_template", "parent_ns_gateway", "parent_ingress_acl_template", "parent_redundancy_group", "parent_gateway"},
            },
            "parent_ingress_adv_fwd_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_enterprise", "parent_egress_acl_template", "parent_vport", "parent_ns_gateway", "parent_ingress_acl_template", "parent_redundancy_group", "parent_gateway"},
            },
            "parent_ns_gateway": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_enterprise", "parent_egress_acl_template", "parent_vport", "parent_ingress_adv_fwd_template", "parent_ingress_acl_template", "parent_redundancy_group", "parent_gateway"},
            },
            "parent_ingress_acl_template": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_enterprise", "parent_egress_acl_template", "parent_vport", "parent_ingress_adv_fwd_template", "parent_ns_gateway", "parent_redundancy_group", "parent_gateway"},
            },
            "parent_redundancy_group": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_enterprise", "parent_egress_acl_template", "parent_vport", "parent_ingress_adv_fwd_template", "parent_ns_gateway", "parent_ingress_acl_template", "parent_gateway"},
            },
            "parent_gateway": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_enterprise", "parent_egress_acl_template", "parent_vport", "parent_ingress_adv_fwd_template", "parent_ns_gateway", "parent_ingress_acl_template", "parent_redundancy_group"},
            },
        },
    }
}
