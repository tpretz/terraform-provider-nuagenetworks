    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_l2_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_bridge_interface", "parent_egress_profile", "parent_vport", "parent_ingress_profile"},
            },
            "parent_bridge_interface": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_l2_domain", "parent_egress_profile", "parent_vport", "parent_ingress_profile"},
            },
            "parent_egress_profile": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_l2_domain", "parent_bridge_interface", "parent_vport", "parent_ingress_profile"},
            },
            "parent_vport": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_l2_domain", "parent_bridge_interface", "parent_egress_profile", "parent_ingress_profile"},
            },
            "parent_ingress_profile": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_l2_domain", "parent_bridge_interface", "parent_egress_profile", "parent_vport"},
            },
        },
    }
}
