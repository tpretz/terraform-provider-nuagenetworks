...
func dataSourceSystemConfig() *schema.Resource {
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "nsg_uplink_hold_down_timer": &schema.Schema{
                Type:     schema.TypeInt,
                Computed: true,
            },
            ...
            "saa_s_applications_publish_date": &schema.Schema{
                Type:     schema.TypeString,
                Computed: true,
            },
            ...
            "imported_saa_s_applications_version": &schema.Schema{
                Type:     schema.TypeString,
                Computed: true,
            },
...
func dataSourceSystemConfigRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("saa_s_applications_publish_date", SystemConfig.SaaSApplicationsPublishDate)
    ...
    d.Set("imported_saa_s_applications_version", SystemConfig.ImportedSaaSApplicationsVersion)
    ...
    d.Set("google_maps_api_key", SystemConfig.GoogleMapsAPIKey)
