    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_saa_s_application_type": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_enterprise", "parent_network_macro_group"},
            },
            "parent_enterprise": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_saa_s_application_type", "parent_network_macro_group"},
            },
            "parent_network_macro_group": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_saa_s_application_type", "parent_enterprise"},
            },
        },
    }
}
