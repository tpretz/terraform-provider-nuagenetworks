...
func resourceGatewayRedundantPort() *schema.Resource {
    return &schema.Resource{
        Create: resourceGatewayRedundantPortCreate,
        Read:   resourceGatewayRedundantPortRead,
        Update: resourceGatewayRedundantPortUpdate,
        Delete: resourceGatewayRedundantPortDelete,
...
func resourceGatewayRedundantPortCreate(d *schema.ResourceData, m interface{}) error {

    // Initialize GatewayRedundantPort object
    o := &vspk.GatewayRedundantPort{
    ...
    return resourceGatewayRedundantPortRead(d, m)
}

func resourceGatewayRedundantPortRead(d *schema.ResourceData, m interface{}) error {
    o := &vspk.GatewayRedundantPort{
        ID: d.Id(),
    }
...
func resourceGatewayRedundantPortUpdate(d *schema.ResourceData, m interface{}) error {
    o := &vspk.GatewayRedundantPort{
        ID: d.Id(),
    }
...
func resourceGatewayRedundantPortDelete(d *schema.ResourceData, m interface{}) error {
    o := &vspk.GatewayRedundantPort{
        ID: d.Id(),
    }
