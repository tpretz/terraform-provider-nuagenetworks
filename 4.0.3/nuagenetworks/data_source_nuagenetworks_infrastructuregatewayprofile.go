...
func dataSourceInfrastructureGatewayProfile() *schema.Resource {
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "revert_behaviour": &schema.Schema{
                Type:     schema.TypeBool,
                Computed: true,
            },
            "revert_timer": &schema.Schema{
                Type:     schema.TypeInt,
                Computed: true,
            },
...
func dataSourceInfrastructureGatewayProfileRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("remote_log_dir_path", InfrastructureGatewayProfile.RemoteLogDirPath)
    d.Set("remote_log_mode", InfrastructureGatewayProfile.RemoteLogMode)
    d.Set("remote_log_password", InfrastructureGatewayProfile.RemoteLogPassword)
    ...
    d.Set("remote_log_username", InfrastructureGatewayProfile.RemoteLogUsername)
    ...
    d.Set("revert_behaviour", InfrastructureGatewayProfile.RevertBehaviour)
    d.Set("revert_timer", InfrastructureGatewayProfile.RevertTimer)
    ...
    d.Set("system_sync_window", InfrastructureGatewayProfile.SystemSyncWindow)
