...
func dataSourceIKEEncryptionprofileRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("dpd_retry_interval", IKEEncryptionprofile.DPDRetryInterval)
    d.Set("dpd_timeout", IKEEncryptionprofile.DPDTimeout)
    d.Set("ip_sec_authentication_algorithm", IKEEncryptionprofile.IPSecAuthenticationAlgorithm)
    d.Set("ip_sec_dont_fragment", IKEEncryptionprofile.IPSecDontFragment)
    d.Set("ip_sec_enable_pfs", IKEEncryptionprofile.IPSecEnablePFS)
    d.Set("ip_sec_encryption_algorithm", IKEEncryptionprofile.IPSecEncryptionAlgorithm)
    d.Set("ip_sec_pre_fragment", IKEEncryptionprofile.IPSecPreFragment)
    d.Set("ip_sec_sa_lifetime", IKEEncryptionprofile.IPSecSALifetime)
    d.Set("ip_sec_sa_replay_window_size", IKEEncryptionprofile.IPSecSAReplayWindowSize)
