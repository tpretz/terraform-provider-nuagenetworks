    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_mirror_destination": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_ingress_adv_fwd_template"},
            },
...
func dataSourceIngressAdvFwdEntryTemplateRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("associated_application_object_id", IngressAdvFwdEntryTemplate.AssociatedApplicationObjectID)
    d.Set("associated_application_object_type", IngressAdvFwdEntryTemplate.AssociatedApplicationObjectType)
