    ...
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "parent_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_mirror_destination", "parent_l2_domain", "parent_egress_acl_template"},
            },
            "parent_mirror_destination": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_l2_domain", "parent_egress_acl_template"},
            },
            "parent_l2_domain": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                ConflictsWith: []string{"parent_domain", "parent_mirror_destination", "parent_egress_acl_template"},
            },
...
func dataSourceEgressACLEntryTemplateRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("reflexive", EgressACLEntryTemplate.Reflexive)
