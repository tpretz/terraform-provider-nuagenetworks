...
func dataSourceVCenterClusterRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("manage_vrs_availability", VCenterCluster.ManageVRSAvailability)
    ...
    d.Set("secondary_data_uplink_vdf_control_vlan", VCenterCluster.SecondaryDataUplinkVDFControlVLAN)
    ...
    d.Set("primary_data_uplink_vdf_control_vlan", VCenterCluster.PrimaryDataUplinkVDFControlVLAN)
