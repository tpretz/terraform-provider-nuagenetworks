...
func resourceInfrastructureVscProfile() *schema.Resource {
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "second_controller_v6": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                Computed: true,
            },
            ...
            "first_controller_v6": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                Computed: true,
            },
...
func resourceInfrastructureVscProfileCreate(d *schema.ResourceData, m interface{}) error {
    ...
    if attr, ok := d.GetOk("second_controller_v6"); ok {
        o.SecondControllerV6 = attr.(string)
    }
    ...
    if attr, ok := d.GetOk("first_controller_v6"); ok {
        o.FirstControllerV6 = attr.(string)
    }
...
func resourceInfrastructureVscProfileRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("second_controller_v6", o.SecondControllerV6)
    d.Set("description", o.Description)
    d.Set("first_controller", o.FirstController)
    d.Set("first_controller_v6", o.FirstControllerV6)
