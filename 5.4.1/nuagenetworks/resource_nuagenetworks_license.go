...
func resourceLicense() *schema.Resource {
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "licensed_feature": &schema.Schema{
                Type:     schema.TypeString,
                Optional: true,
                Computed: true,
            },
            ...
            "allowed_vdfgs_count": &schema.Schema{
                Type:     schema.TypeInt,
                Optional: true,
                Computed: true,
            },
            "allowed_vdfs_count": &schema.Schema{
                Type:     schema.TypeInt,
                Optional: true,
                Computed: true,
            },
...
func resourceLicenseCreate(d *schema.ResourceData, m interface{}) error {
    ...
    if attr, ok := d.GetOk("allowed_vdfgs_count"); ok {
        o.AllowedVDFGsCount = attr.(int)
    }
    if attr, ok := d.GetOk("allowed_vdfs_count"); ok {
        o.AllowedVDFsCount = attr.(int)
    }
...
func resourceLicenseRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("licensed_feature", o.LicensedFeature)
    ...
    d.Set("allowed_vdfgs_count", o.AllowedVDFGsCount)
    d.Set("allowed_vdfs_count", o.AllowedVDFsCount)
