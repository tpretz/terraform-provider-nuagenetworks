...
func dataSourceNSGatewayRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("zfb_match_attribute", NSGateway.ZFBMatchAttribute)
    d.Set("zfb_match_value", NSGateway.ZFBMatchValue)
    ...
    d.Set("network_acceleration", NSGateway.NetworkAcceleration)
