...
func dataSourceLicenseStatus() *schema.Resource {
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            ...
            "total_licensed_used_vdfgs_count": &schema.Schema{
                Type:     schema.TypeInt,
                Computed: true,
            },
            "total_licensed_used_vdfs_count": &schema.Schema{
                Type:     schema.TypeInt,
                Computed: true,
            },
            ...
            "total_licensed_vdfgs_count": &schema.Schema{
                Type:     schema.TypeInt,
                Computed: true,
            },
            "total_licensed_vdfs_count": &schema.Schema{
                Type:     schema.TypeInt,
                Computed: true,
            },
...
func dataSourceLicenseStatusRead(d *schema.ResourceData, m interface{}) error {
    ...
    d.Set("total_licensed_used_vdfgs_count", LicenseStatus.TotalLicensedUsedVDFGsCount)
    d.Set("total_licensed_used_vdfs_count", LicenseStatus.TotalLicensedUsedVDFsCount)
    ...
    d.Set("total_licensed_vdfgs_count", LicenseStatus.TotalLicensedVDFGsCount)
    d.Set("total_licensed_vdfs_count", LicenseStatus.TotalLicensedVDFsCount)
